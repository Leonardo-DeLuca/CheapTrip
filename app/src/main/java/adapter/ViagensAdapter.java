...
public class ViagensAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        String numeroViajantes = "" + listaViagens.get(i).getTotalViajantes();
        String duracao = "" + listaViagens.get(i).getDuracao();
        String data = listaViagens.get(i).getDataCriacaoString();
